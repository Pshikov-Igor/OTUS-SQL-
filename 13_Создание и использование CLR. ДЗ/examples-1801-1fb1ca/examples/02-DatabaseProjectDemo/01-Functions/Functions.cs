...
public class ScalarFunctions
{
    ...
    // если предоставлять им один и тот же набор входных значений и использовать одно и то же состояние базы данных.
    // Недетерминированные функции могут возвращать каждый раз разные результаты.
    // 
    // Влияет на то, где можно использовать функцию (индексированные представления, persisted-колоники и др).
